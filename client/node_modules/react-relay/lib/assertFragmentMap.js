...
function assertFragmentMap(componentName, fragments) {
  !(fragments && typeof fragments === 'object') ? process.env.NODE_ENV !== "production" ? invariant(false, 'Could not create Relay Container for `%s`. ' + 'Expected a set of GraphQL fragments, got `%s` instead.', componentName, fragments) : invariant(false) : void 0;
